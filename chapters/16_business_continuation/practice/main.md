...
### Question 1
**Which of the following is NOT a typical feature of a cross-purchase agreement?**
...
### Question 3
**Which of the following is true about Section 303 of the Internal Revenue Code?**
...
### Question 4
**What is the main advantage of a wait-and-see agreement?**
...
### Question 5
**Which of the following is NOT a typical method of business valuation?**
- a) Asset approach
- b) Income approach
- c) Market approach
...
### Question 1
**True or False:** A sole proprietorship provides limited liability protection to its owner.
...
### Question 2
**True or False:** An ESOP is a type of qualified retirement plan.
...
### Question 3
**True or False:** Business overhead insurance provides income replacement for disabled employees.
...
### Question 4
**True or False:** Section 6166 allows for tax-free transfers of business interests.
...
### Question 5
**True or False:** A promissory note is a type of insurance policy.
...
### Scenario 1
**A client owns a successful family business and wants to implement a succession plan. What factors should be considered?**
...
### Scenario 2
**A client wants to implement a buy-sell agreement. What steps should be taken?**
...
### Scenario 3
**A client is concerned about the costs of business continuation planning. What costs should be explained?**
...
### Scenario 4
**A client wants to structure their business for optimal succession planning. What options should be considered?**
...
### Scenario 5
**A client is approaching retirement and wants to understand their business continuation options. What should be explained?**
